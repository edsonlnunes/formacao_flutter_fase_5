...
mixin _$DetailStore on DetailStoreBase, Store {
  ...
  late final _$pokemonDetailsAtom =
      Atom(name: 'DetailStoreBase.pokemonDetails', context: context);
  ...
  late final _$getPokemonDetailsDataAsyncAction =
      AsyncAction('DetailStoreBase.getPokemonDetailsData', context: context);

  @override
  Future<void> getPokemonDetailsData(String nameOrId) {
    return _$getPokemonDetailsDataAsyncAction
        .run(() => super.getPokemonDetailsData(nameOrId));
  }
